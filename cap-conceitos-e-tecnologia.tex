...
Java Persistence API é uma especificação Java EE que fornece uma solução ORM
(Object-Relational Mapping) para persistência de dados em uma aplicação Java.
