...
Nesse exemplo, o maven irá baixar todas as bibliotecas do Hibernate e suas
dependências também, ou seja, a API da JPA e qualquer outra biblioteca
necessária para o seu funcionamento. Dessa forma, delegamos todo o trabalho de
adição, remoção, ou melhor, de gerenciamento de todas as bibliotecas e APIs para
o Maven.
