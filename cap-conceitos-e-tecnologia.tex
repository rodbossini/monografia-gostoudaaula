...
finalidade de fazer o \emph{build} (construção) do projeto resolvendo os problemas de: gerenciamento de
...
comportará. A biblioteca do Maven é gratuita e pode ser
adquirida conforme o link disponibilizado na bibliografia.
