...
\begin{figure}[H]
  ...
  \caption{Participação no mercado. Fonte: IDC}
...
A partir dessa arquitetura, podemos desenvolver uma aplicação de uma forma mais
organizada e segura, pois além de dividirmos todo o conteúdo de acesso ao
...
menos bugs, pois ao invés de criar a aplicação toda para depois testá-la, 
...
para implementar esses testes utilizamos o framework JUnit que fornece
